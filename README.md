...
В этом мануале не всегда понятно, из какой папки выполнять команду, в связи с чем иногда может возникнуть ошибка file not found. В таких случаях придется внимательно прочитать сообщение комментарии мануала, взглянуть на предыдущие действия и прикинуть где должна исполняться та или иная команда. Возможно придется вручную скопировать файл.
...
…
Возможно появление ошибки, если не хватит памяти.
